    ...
    public List<LearningResource> resources() {
        ...
        return List.of(
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.ALGORITHMS, ResourceCategory.JAVA),
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.LANGUAGE_FEATURES),
                        Set.of("java", "collections", "list", "map", "set", "queue",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.ALGORITHMS,
                                ConceptArea.COMPLEXITY_ANALYSIS),
                        Set.of("data-structures", "algorithms", "interactive", "textbook",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.ALGORITHMS, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.ALGORITHMS),
                        Set.of("visualizer", "bst", "avl-tree", "red-black-tree", "b-tree",
                ...
                new LearningResource(
                        ...
                        Set.of("neetcode", "roadmap", "leetcode", "interview", "patterns",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.ALGORITHMS, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.ALGORITHMS),
                        Set.of("geeksforgeeks", "data-structures", "arrays", "linked-list",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.ALGORITHMS,
                                ConceptArea.COMPLEXITY_ANALYSIS),
                        Set.of("mit", "algorithms", "university", "avl", "hash-tables",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.ALGORITHMS, ResourceCategory.PYTHON),
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.LANGUAGE_FEATURES),
                        Set.of("python", "data-structures", "list", "dict", "set", "tuple",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.DATA_STRUCTURES, ConceptArea.ALGORITHMS,
                                ConceptArea.COMPLEXITY_ANALYSIS),
                        Set.of("skiena", "algorithm-design-manual", "practical", "book",
