    ...
    public List<LearningResource> resources() {
        ...
        return List.of(
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.SOFTWARE_ENGINEERING, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.GETTING_STARTED, ConceptArea.ARCHITECTURE,
                                ConceptArea.ALGORITHMS),
                        Set.of("build-your-own", "hands-on", "learn-by-doing", "projects",
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.SOFTWARE_ENGINEERING, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.GETTING_STARTED, ConceptArea.LANGUAGE_BASICS),
                        Set.of("project-based", "tutorials", "hands-on", "learn-by-doing",
                                "multi-language"),
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.CAREER_DEVELOPMENT, ConceptArea.CLEAN_CODE,
                                ConceptArea.SELF_IMPROVEMENT, ConceptArea.COMMUNICATION_SKILLS),
                        Set.of("professional", "career", "must-read", "books", "articles",
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.ALGORITHMS, ResourceCategory.SOFTWARE_ENGINEERING),
                        Set.of(ConceptArea.INTERVIEW_PREP, ConceptArea.ALGORITHMS,
                                ConceptArea.DATA_STRUCTURES, ConceptArea.SYSTEM_DESIGN),
                        Set.of("interview-prep", "study-plan", "cs-fundamentals",
                ...
                new LearningResource(
                        ...
                        Set.of("self-taught", "cs-degree", "free-education", "curriculum",
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.GENERAL),
                        Set.of(ConceptArea.GETTING_STARTED, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("awesome", "curated-list", "meta-resource", "comprehensive",
                                "community-driven"),
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.GENERAL, ResourceCategory.DEVOPS,
                                ResourceCategory.SECURITY),
                        Set.of(ConceptArea.GETTING_STARTED, ConceptArea.WEB_SECURITY,
                                ConceptArea.CONTAINERS),
                        Set.of("cheatsheets", "cli-tools", "security", "devops", "linux",
                                "networking", "hacking"),
                        "trimstray / Community",
                        DifficultyLevel.INTERMEDIATE,
                        ContentFreshness.ACTIVELY_MAINTAINED,
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.PERSONAL_DEVELOPMENT),
                        Set.of(ConceptArea.SELF_IMPROVEMENT, ConceptArea.COMMUNICATION_SKILLS),
                        Set.of("books", "self-help", "psychology", "philosophy",
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.SOFTWARE_ENGINEERING, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.CAREER_DEVELOPMENT, ConceptArea.ARCHITECTURE,
                                ConceptArea.DISTRIBUTED_SYSTEMS),
                        Set.of("must-know", "fundamentals", "engineering-culture",
                ...
                new LearningResource(
                        ...
                        Set.of("free-books", "ebooks", "subjects", "cs-books",
                                "programming-books"),
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.GENERAL),
                        Set.of(ConceptArea.GETTING_STARTED, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("free-courses", "online-learning", "mooc", "self-paced",
                                "programming-courses"),
                        "Ebook Foundation / Community",
                        DifficultyLevel.BEGINNER,
                        ContentFreshness.ACTIVELY_MAINTAINED,
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.PRODUCTIVITY,
                                ResourceCategory.PERSONAL_DEVELOPMENT),
                        Set.of(ConceptArea.PRODUCTIVITY_HABITS, ConceptArea.SELF_IMPROVEMENT),
                        Set.of("productivity", "time-management", "habits", "focus",
                                "deep-work", "tools"),
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.PERSONAL_DEVELOPMENT),
                        Set.of(ConceptArea.COMMUNICATION_SKILLS, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("public-speaking", "presentations", "storytelling",
                ...
                new LearningResource(
                        ...
                        ResourceType.REPOSITORY,
                        Set.of(ResourceCategory.PERSONAL_DEVELOPMENT),
                        Set.of(ConceptArea.FINANCIAL_LITERACY),
                        Set.of("personal-finance", "budgeting", "investing", "tax",
