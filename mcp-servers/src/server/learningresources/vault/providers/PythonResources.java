    ...
    public List<LearningResource> resources() {
        ...
        return List.of(
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PYTHON),
                        Set.of(ConceptArea.LANGUAGE_FEATURES, ConceptArea.OOP,
                                ConceptArea.MEMORY_MANAGEMENT),
                        Set.of("official", "reference", "syntax", "data-model", "import-system"),
                        "Python Software Foundation",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PYTHON),
                        Set.of(ConceptArea.CLEAN_CODE, ConceptArea.LANGUAGE_FEATURES,
                                ConceptArea.API_DESIGN),
                        Set.of("official", "pep", "style-guide", "type-hints", "proposals"),
                        "Python Software Foundation",
                ...
                new LearningResource(
                        ...
                        ResourceType.TUTORIAL,
                        Set.of(ResourceCategory.PYTHON),
                        Set.of(ConceptArea.LANGUAGE_BASICS, ConceptArea.TESTING,
                                ConceptArea.CONCURRENCY, ConceptArea.API_DESIGN),
                        Set.of("tutorials", "web", "data-science", "testing", "async",
