    ...
    public List<LearningResource> resources() {
        ...
        return List.of(
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("second-brain", "pkm", "tiago-forte", "basb", "code-method",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("para", "para-method", "projects", "areas", "resources", "archives",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("code-method", "capture", "organize", "distill", "express",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT),
                        Set.of("zettelkasten", "slip-box", "permanent-notes", "literature-notes",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.GETTING_STARTED),
                        Set.of("obsidian", "markdown", "bidirectional-links", "graph-view",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.GETTING_STARTED),
                        Set.of("notion", "databases", "pages", "templates", "cloud-based",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.GETTING_STARTED),
                        Set.of("logseq", "open-source", "outliner", "markdown", "org-mode",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.GETTING_STARTED),
                        Set.of("onenote", "microsoft", "office", "notebook", "microsoft-365",
                ...
                new LearningResource(
                        ...
                        ResourceType.BLOG,
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.SOFTWARE_ENGINEERING),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.CAREER_DEVELOPMENT,
                                ConceptArea.ARCHITECTURE),
                        Set.of("pkm", "developer", "software-engineer", "adr", "learning-journal",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT),
                        Set.of("migration", "notion-to-obsidian", "import", "obsidian", "notion",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("todoist", "tasks", "todos", "gtd", "para", "action-management",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT),
                        Set.of("progressive-summarization", "pkm", "tiago-forte", "distill",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.GETTING_STARTED),
                        Set.of("obsidian", "plugins", "dataview", "templater", "git-sync",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.GETTING_STARTED),
                        Set.of("foam", "vscode", "vs-code", "pkm", "markdown", "backlinks",
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.PRODUCTIVITY, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.KNOWLEDGE_MANAGEMENT, ConceptArea.CAREER_DEVELOPMENT),
                        Set.of("gtd", "getting-things-done", "david-allen", "productivity",
