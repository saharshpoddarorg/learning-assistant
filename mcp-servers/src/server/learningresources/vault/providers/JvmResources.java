    ...
    public List<LearningResource> resources() {
        ...
        return List.of(
                ...
                new LearningResource(
                        ...
                        Set.of(ResourceCategory.JAVA, ResourceCategory.SYSTEMS),
                        Set.of(ConceptArea.JVM_INTERNALS,
                                ConceptArea.CLASS_LOADING,
                                ConceptArea.MEMORY_MANAGEMENT,
                                ConceptArea.LANGUAGE_FEATURES),
                        Set.of("official", "jvms", "specification", "bytecode", "class-file",
                ...
                new LearningResource(
                        ...
                        Set.of("jvm-internals", "hotspot", "tlab", "safepoints", "gc",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.JAVA, ResourceCategory.SYSTEMS),
                        Set.of(ConceptArea.GARBAGE_COLLECTION,
                                ConceptArea.JVM_INTERNALS,
                                ConceptArea.MEMORY_MANAGEMENT),
                        Set.of("official", "gc", "garbage-collection", "g1", "zgc",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.GARBAGE_COLLECTION,
                                ConceptArea.JVM_INTERNALS,
                                ConceptArea.MEMORY_MANAGEMENT),
                        Set.of("gc", "garbage-collection", "g1", "zgc", "shenandoah",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.JVM_INTERNALS, ConceptArea.COMPLEXITY_ANALYSIS,
                                ConceptArea.TESTING),
                        Set.of("jmh", "benchmarking", "performance", "microbenchmark",
                                "warm-up", "jit", "openjdk"),
                        "OpenJDK",
                        DifficultyLevel.ADVANCED,
                        ContentFreshness.ACTIVELY_MAINTAINED,
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.JVM_INTERNALS,
                                ConceptArea.GARBAGE_COLLECTION,
                                ConceptArea.MEMORY_MANAGEMENT),
                        Set.of("jvm-flags", "jvm-parameters", "heap-size", "xmx", "xms",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.JVM_INTERNALS,
                                ConceptArea.MEMORY_MANAGEMENT,
                                ConceptArea.GARBAGE_COLLECTION),
                        Set.of("stack", "heap", "method-area", "runtime-data-areas",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.JAVA, ResourceCategory.SYSTEMS),
                        Set.of(ConceptArea.JVM_INTERNALS, ConceptArea.ARCHITECTURE,
                                ConceptArea.CONTAINERS),
                        Set.of("graalvm", "native-image", "aot", "ahead-of-time",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.JAVA, ResourceCategory.GENERAL),
                        Set.of(ConceptArea.JVM_LANGUAGES,
                                ConceptArea.JVM_INTERNALS,
                                ConceptArea.LANGUAGE_FEATURES,
                                ConceptArea.CONCURRENCY,
                                ConceptArea.FUNCTIONAL_PROGRAMMING),
                        Set.of("kotlin", "jvm-language", "coroutines", "null-safety",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.JVM_LANGUAGES,
                                ...
                                ConceptArea.FUNCTIONAL_PROGRAMMING,
                                ConceptArea.OOP),
                        Set.of("scala", "jvm-language", "functional", "pattern-matching",
                ...
                new LearningResource(
                        ...
                        Set.of("groovy", "jvm-language", "dynamic", "gradle-dsl",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.JVM_LANGUAGES,
                                ...
                                ConceptArea.FUNCTIONAL_PROGRAMMING,
                                ConceptArea.CONCURRENCY),
                        Set.of("clojure", "jvm-language", "lisp", "functional",
                ...
                new LearningResource(
                        ...
                        Set.of(ConceptArea.JVM_INTERNALS,
                                ...
                                ConceptArea.MEMORY_MANAGEMENT,
                                ConceptArea.CONCURRENCY),
                        Set.of("awesome-list", "jvm", "performance", "profiling",
                ...
                new LearningResource(
                        ...
                        ResourceType.BLOG,
                        Set.of(ResourceCategory.JAVA, ResourceCategory.SYSTEMS),
                        Set.of(ConceptArea.JVM_INTERNALS, ConceptArea.CONCURRENCY,
                                ConceptArea.MEMORY_MANAGEMENT),
                        Set.of("mechanical-sympathy", "performance", "cpu-cache",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.JAVA, ResourceCategory.TOOLS),
                        Set.of(ConceptArea.JVM_INTERNALS, ConceptArea.OBSERVABILITY),
                        Set.of("official", "jfr", "java-flight-recorder", "jmc",
                ...
                new LearningResource(
                        ...
                        ResourceType.ARTICLE,
                        Set.of(ResourceCategory.JAVA),
                        Set.of(ConceptArea.CLASS_LOADING,
                                ConceptArea.JVM_INTERNALS),
                        Set.of("class-loading", "classloader", "bootstrap-classloader",
                ...
                new LearningResource(
                        ...
                        ResourceType.DOCUMENTATION,
                        Set.of(ResourceCategory.JAVA, ResourceCategory.SYSTEMS),
                        Set.of(ConceptArea.SERIALIZATION,
                                ConceptArea.JVM_INTERNALS,
                                ConceptArea.WEB_SECURITY),
                        Set.of("official", "serialization", "deserialization", "serializable",
                ...
                new LearningResource(
                        ...
                        ResourceType.ARTICLE,
                        Set.of(ResourceCategory.JAVA),
                        Set.of(ConceptArea.SERIALIZATION, ConceptArea.JVM_INTERNALS),
                        Set.of("serialization", "deserialization", "serializable",
