...
|--------|-------------|------|
| **Learning Resources** | ⚠️ **DEPRECATED** — Migrated to `learning-resources-vault` skill (`.github/skills/learning-resources-vault/`). 138 curated resources now served as Markdown tables in 10 sub-files. Works in all Copilot modes without JVM. Code preserved as MCP reference implementation. | [README](src/server/learningresources/README.md) |
