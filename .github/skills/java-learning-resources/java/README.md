# Java Learning Resources — Sub-Index

> Navigate to the specific reference you need.
...
│   └── jdk-apis-reference.md      ← JDK API deep dives: Concurrency, Streams, Gatherers,
│                                     Exceptions, Collections, I/O, Date-Time, etc.
├── community/                     ← Blogs, books, open-source projects
│   ├── blogs-and-community-guide.md ← Inside.java, Baeldung, Jenkov, YouTube, books
│   └── open-source-study-guide.md   ← OSS project study methodology & deep dives
└── README.md                      ← This file
```
...
| [`community/open-source-study-guide.md`](community/open-source-study-guide.md) | Study methodology, deep dives into Guava, JUnit 5, Spring Boot, Caffeine, Jackson, Resilience4j, Javalin, MapStruct — with code patterns | Learning from real-world Java projects |
