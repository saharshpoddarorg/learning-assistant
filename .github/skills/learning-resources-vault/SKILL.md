...
description: >
  ...
  books, Teach Yourself CS, CS50x, Build Your Own X, project-based learning, Coding Interview
  University, OSSU, Awesome Lists, professional programming, personal finance).
...
| Domain | Resources | Sub-File |
|---|---|---|
| Java | 20 | [resources-java.md](resources-java.md) |
...
| Advanced | 🔴 | Solid understanding required |
| Expert | ⚫ | Research-level / formal specs |
...
| 🔤 | Multi-language |
| ☕ | Java-specific / Java-centric |
| 🐍 | Python-specific |
| 🌐✦ | Web-specific (JS/TS/HTML/CSS) |
...
| Category | Slug | Sub-File |
|---|---|---|
| Java | java | resources-java.md |
| Python | python | resources-python.md |
| JavaScript | javascript | resources-web-javascript.md |
| Web | web | resources-web-javascript.md |
| Algorithms | algorithms | resources-algorithms-ds.md |
| Software Engineering | software-engineering | resources-software-engineering.md |
| Testing | testing | resources-software-engineering.md |
| DevOps | devops | resources-devops-vcs-build.md |
| Tools | tools | resources-devops-vcs-build.md |
| Cloud | cloud | resources-cloud-infra.md |
| Database | database | resources-cloud-infra.md |
| Security | security | resources-cloud-infra.md |
| Systems | systems | resources-cloud-infra.md |
| AI/ML | ai-ml | resources-ai-ml.md |
| Productivity | productivity | resources-productivity-pkm.md |
| General | general | resources-general-career.md |
| Personal Development | personal-development | resources-general-career.md |
...
| Mode | How to Ask | Example |
|---|---|---|
| Specific | Ask by name or use precise terms | "Show me the JUnit 5 User Guide" |
| Topic | Describe the topic area | "What resources cover Java concurrency?" |
| Guided | Describe your level and goals | "I'm a beginner — recommend Java resources" |

### Filtering

Combine any dimensions:

- **By difficulty:** "beginner Java resources" → 🟢 in Java sub-file
- **By type:** "Java books" → 📚 type in Java sub-file
- **By freshness:** "actively maintained Python docs" → 🔄 in Python sub-file
- **By language scope:** "universal design resources" → 🌐 in SE sub-file
- **By concept + difficulty:** "advanced concurrency" → 🔴 + Concurrency concept
...
- For in-depth Java content (scraped tutorials, API deep-dives): `java-learning-resources` skill
- For SE methodology details (book summaries, pattern catalogs): `software-engineering-resources` skill
- For career role guidance and skills matrices: `career-resources` skill
- For digital note-taking workflows: `digital-notetaking` skill
