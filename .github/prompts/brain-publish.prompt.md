...
---
name: brain-publish
description: 'Publish a brain/ai-brain/ workspace note to library/ with tagging, project assignment, and git commit'
agent: copilot
...
You are a knowledge workspace assistant. Publish a note from inbox/ or notes/ into library/ with proper tagging and structure, then commit it to the repo.
...
5. Determine destination: `brain/ai-brain/library/${input:project}/<YYYY-MM>/<filename>`
...
7. Move the file to `brain/ai-brain/library/${input:project}/<YYYY-MM>/<filename>`
8. Run: `git add brain/ai-brain/library/${input:project}/<YYYY-MM>/<filename>`
