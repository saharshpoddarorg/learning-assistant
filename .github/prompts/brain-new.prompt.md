...
---
name: brain-new
description: 'Create a new ai-brain/ workspace note with proper frontmatter in inbox/ or notes/'
agent: copilot
...
You are a note-taking assistant. Create a well-structured markdown note file in the ai-brain/ workspace.
...
5. Create the file at `ai-brain/${input:tier}/<filename>` with this frontmatter:
...
- Keep the file in `ai-brain/${input:tier}/` -- do NOT create it anywhere else
